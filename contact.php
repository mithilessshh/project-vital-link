...
<head>
  ...
  <title>Vitallink - connect the donors</title>
...
<body id="top">
  ...
  <header class="header">
      ...
      <div class="container">
        <ul class="contact-list">
          <li class="contact-item">
            ...
            <a href="mailto:redstream001@gmail.com" class="contact-link">vitallink247@gmail.com</a>
          </li>
          <li class="contact-item">
    ...
    <div class="header-bottom" data-header>
      <div class="container">
        <a href="#" class="logo">Vital Link</a>
  ...
  <footer class="footer">
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="https://g.co/kgs/agXkMDQ">
            <address class="item-text">
            Odisha Blood Bank,<br>
            Bhubaneswar, Khordha, Odisha IN
            </address>
          </a>
          </li>
          <li class="footer-item">
          ...
          <li class="footer-item">
            ...
            <a href="mailto:help@example.com" class="footer-link">vitallink247@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright">
          &copy; 2024 All Rights Reserved by Vital Link
        </p>
        <ul class="social-list">
          <li>
            <a href="https://www.facebook.com/andro.pool.54?mibextid=ZbWKwL" class="social-link">
